...
export default function About() {
  return (
    <div className='flex flex-col gap-8 p-8 md:p-16 max-w-6xl mx-auto'>
      <header>
        <h1 className='text-slate-700 font-bold text-4xl md:text-6xl'>
      ...
      <section className='mt-12'>
        ...
        <h2 className='text-slate-700 font-bold text-2xl md:text-4xl mt-8'>
          How It Works
        </h2>
        <ol className='list-decimal text-gray-500 text-sm sm:text-base mt-4 pl-4'>
      ...
      <section className='text-gray-500 text-sm sm:text-base mt-8'>
        <p>
