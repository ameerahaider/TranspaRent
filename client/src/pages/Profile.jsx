  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-slate-700 font-semibold text-center mt-2">Index ID: {currentUser.index}</p>
        {/* Display the Ethereum account address */}
        <p className="text-slate-700 font-semibold text-center mt-2">Account Address: {accountAddress}</p>
      ...
      {userListings && userListings.length > 0 && 
        <div className="flex flex-col gap-4">
          <h1 className="text-center mt-7 text-2xl front-semibold">Your Listings</h1>
